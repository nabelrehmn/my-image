        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddess = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrintSizes", x => x.SizeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingStatus = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Photographs", x => x.PhotoId);
                    table.ForeignKey(
                        name: "FK_Photographs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TracingNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Photographs_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photographs",
                        principalColumn: "PhotoId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CartItems_PrintSizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Photographs_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photographs",
                        principalColumn: "PhotoId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_OrderItems_PrintSizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "PrintSizes",
                        principalColumn: "SizeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "57e3c6da-b5d1-4d7a-80ff-2ae8636190f5", "1d5c906e-5f31-42e1-87a8-65f548218f27", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "a48a8dca-380f-49a1-a641-bd677d335383", "9647b7de-b519-4274-b0e2-e4afe1884892", "client", "client" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingInfo_TracingNumber",
                table: "ShippingInfo",
                column: "TracingNumber",
                unique: true);
        }
